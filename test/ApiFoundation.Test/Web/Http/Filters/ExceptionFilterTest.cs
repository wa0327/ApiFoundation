...
namespace ApiFoundation.Web.Http.Filters
{
    ...
    {
        [TestMethod]
        public void ExceptionFilterTest__BusinessError()
        {
        ...
        [TestMethod]
        public void ExceptionFilterTest__BusinessError_Encrypted()
        {
        ...
        [TestMethod]
        public void ExceptionFilterTest__ProgramError()
        {
            using (var server = new ApiServerWrapper())
            {
                using (ApiClient client = new ApiClientWrapper())
        ...
        [TestMethod]
        public void ExceptionFilterTest__ProgramError_Encrypted()
        {
