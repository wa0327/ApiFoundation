...
namespace ApiFoundation.Services
{
    ...
    public class ServiceClientTest
    {
        ...
        [TestMethod]
        public void ServiceClient_NoServer()
        {
            try
            {
        ...
        /// </summary>
        [TestMethod]
        public void ServiceClient_LmsApi_InvalidCertificate()
        {
            try
            {
        ...
        /// </summary>
        [TestMethod]
        public void ServiceClient_LmsApi_GetTimestamp_InvalidMethod()
        {
            // 略過憑證檢查
        ...
        [TestMethod]
        public void ServiceClient_LmsApi_GetTimestamp()
        {
            // 略過憑證檢查
            ServicePointManager.ServerCertificateValidationCallback = (sender, certificate, chain, sslPolicyErrors) => true;
        ...
        [TestMethod]
        public void ServiceClient_ErpApi_GetUserAuthority()
        {
